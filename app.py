        ...
        try:
            ...
            for update in updates:
                if update.message:
                    ...
                    # Photo Message Handling (Corrected Method)
                        ...
                        try:
                            # Use the correct 'send_image' method and 'text' for caption
                            rubika_bot.send_image(
                                chat_id=RUBIKA_TARGET_CHAT_ID,
                                path=temp_photo_path,
                                text=forwarded_caption
                            )
